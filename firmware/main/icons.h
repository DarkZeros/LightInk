...
// constexpr std::array input = {0x12, 0x34, 0x56};
// static_assert(RLE1B<input>::view.size() == 3);


// static_assert(RLE1B<wifioff2>::view.size() == wifioff2.size());

// static_assert(RLETestA<wifioff2>::view.size() == wifioff2.size());